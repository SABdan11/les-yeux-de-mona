const OEUVRES = [
  ...
  },
  {
    ...
    "ce_quon_voit": ["Une grande masse sombre occupe le centre du tableau. Ce n'est pas tout à fait un aplat de noir : c'est une nappe vibrante, soufflée, dont les bords supérieur et inférieur se dissipent comme de la brume. En bas, une bande jaune citron, étroite, rainurée de fins sillons verticaux qui lui donnent un dynamisme vif. En haut, une bande de bleu profond, très mince, presque écrasée contre le bord du cadre — comme un bout de ciel qui pointe timidement derrière les tumultes d'un orage. Ces trois zones : jaune, noir, bleu. C'est tout. Et c'est immense.", "Et puis, dans la masse noire : trois traits d'une netteté fulgurante. Comme trois hautes herbes, ou trois longs cheveux isolés — légèrement courbés, souples, mais tendus par une énergie puissante. Au centre, le plus grand parcourt presque toute la hauteur de la nappe. À sa gauche, un deuxième, plus fin, suit un mouvement arrondi. À sa droite, un troisième, plus discret, chemine de même. Ensemble, ils font penser à un grand tronc d'arbre effilé qui monte. Ou à un éclair. Ces traits n'ont pas été peints : ils ont été grattés. Hartung a attendu que la peinture acrylique ne soit pas encore sèche, puis il en a retiré une couche superficielle avec une lame. La lumière est apparue en crevant le noir.", "Les nappes colorées ont été appliquées avec un pistolet de carrossier — l'outil qu'on utilise pour peindre les voitures. C'est ce qui donne à la matière cet aspect poudreux, évanescent, comme des nuages. Quand Hans Hartung avait votre âge, il avait peur des orages. Mais il se disait que s'il parvenait à figurer très vite les zigzags de la foudre, alors rien ne pourrait lui arriver. Dans l'angle inférieur droit, la signature : Hartung 64. Le chiffre 9 était son chiffre fétiche — et si vous comptez les éléments du tableau, vous en trouverez exactement neuf."],
  ...
  },
  {
    ...
    "ce_quon_voit": ["Un tableau abstrait aux tons sourds, presque carré — deux mètres de haut sur deux mètres vingt de large. Il est essentiellement composé de cinq bandes foncées disposées à l'horizontale, de manière régulière, sur un grand panneau homogène en médium — c'est-à-dire en fibre de bois. Les bandes sont séparées par quatre traits au pastel clair : quatre rais de lumière. Le panneau de médium est lui-même superposé sur un premier support. Deux marges verticales de dix centimètres demeurent ainsi visibles sur les côtés, bordées d'acrylique noire, avec un jeu de zones blanches et sombres. On devine l'amorce de formes raides ou curvilignes obturées par la superposition.", "Ces bandes ne sont pas monochromes. On y sent les tonalités brunes et changeantes du bois, ses veines et ses aspérités. Un enduit de peinture presque transparente, absorbé à l'aide d'un chiffon, y fait sourdre des bouffées de marron et des vapeurs de gris aux limites du rouillé — il y fait naître des reflets et des lumières. Mona, à son tour, décrit ce qu'elle voit : dans la première bande, un deuil ; dans la deuxième, la joie ; dans la troisième, la croissance ; dans la quatrième, la violence ; dans la cinquième, la guérison. L'œuvre porte en elle tout ce qu'une vie traverse. Et sur les côtés : regardez les marges. Sous le panneau de bois, d'autres formes existent — cachées, mais réelles. Soulages nous apprend l'existence de ce qui échappe à nos yeux.", "Pierre Soulages est né en 1919 dans un milieu modeste du sud de la France. Il vénérait l'art ancien et l'architecture romane. Après-guerre, il s'impose dans l'art abstrait avec un vocabulaire fait de puissantes oppositions entre le clair et l'obscur. En 1979, il invente ses « outrenoirs » : des noirs doués d'une grande qualité luminescente, dont la texture, une fois modelée, démultiplie les nuances et les scintillements. Des noirs qui n'en sont pas. « Le noir est une couleur, dit Mona. C'est même une couleur à perte de vue. » Et si on mélange toutes les couleurs, on obtient du noir — pardi. La leçon ultime : il faut voir au-delà de ce qu'on voit. Regarder sur les côtés en plus du centre, de haut en bas, de bas en haut. Et savoir que, sous ce qu'on aperçoit, il y a toujours plus."],
    "lecon_titre": "Le noir est une couleur",
    "lecon_texte": "Soulages a peint en noir toute sa vie. Et à soixante ans, il a découvert que le noir n'était pas une absence de couleur — c'était une couleur à part entière, la plus complexe de toutes. Le noir de Soulages réfléchit la lumière, il la transforme, il en fait naître d'autres. Le noir est une couleur : cette phrase dit quelque chose de plus profond que la peinture. Elle dit que ce qu'on croit vide peut être plein. Que ce qu'on croit sombre peut être une source de lumière. Que la fin peut être un commencement. C'est la dernière leçon de Mona.",
    ...
    "mot_mystere_texte": "L'Outrenoir est un mot inventé par Pierre Soulages pour désigner sa découverte de 1979 : le noir utilisé non comme couleur qui absorbe la lumière, mais comme surface qui la réfléchit et la transforme. Le préfixe « outre- » vient du latin ultra, « au-delà ». En travaillant la peinture noire en stries épaisses avec une spatule, Soulages crée des surfaces qui agissent comme des prismes : elles décomposent la lumière ambiante en zones d'éclat et d'ombre qui bougent avec le spectateur.",
    "anecdote": "Pierre Soulages est né à Rodez, en Aveyron, à quelques kilomètres de l'abbatiale Sainte-Foy de Conques. En 1994, le musée de Conques lui commanda de nouveaux vitraux. Soulages créa cent quatre fenêtres en verre translucide gris-blanc, sans décor ni figure — juste la lumière filtrée. Les habitants protestèrent : ils voulaient des vitraux colorés. Aujourd'hui, les vitraux de Soulages à Conques sont considérés parmi les plus beaux d'Europe. Il vécut jusqu'à cent deux ans — et travailla jusqu'à la fin."
  }
];