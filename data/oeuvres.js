const OEUVRES = [
  ...
  },
  {
    ...
    "ce_quon_voit": [
      "Une silhouette blanche immense — plus grande qu'un homme — se dresse dans la salle. Au premier regard, c'est une mariée : la robe blanche volumineuse, la forme générale d'une femme le jour de ses noces. Mais en s'approchant, quelque chose cloche. La surface n'est pas lisse : elle est couverte de bosses, de renflements, d'objets qui débordent sous le plâtre blanc.",
      "Regardez attentivement : des poupées, des petites voitures, des fleurs de plastique, des jouets d'enfants sont pris dans le grillage et enfouis sous le blanc. La mariée est littéralement faite d'une accumulation de rôles et de symboles du monde féminin traditionnel — tout ça emmailloté, blanchi à la chaux comme pour le neutraliser.",
      "Le blanc unifie tout, efface tout. Mais quelque chose résiste : les objets emprisonnés font des bosses sous la surface, ils débordent. Niki de Saint Phalle avait rompu avec son milieu de la haute bourgeoisie new-yorkaise pour devenir artiste. La Mariée, c'est tout ce qu'elle avait refusé d'être."
    ],
  ...
  },
  {
    ...
    "ce_quon_voit": [
      "Un fond bleu-gris, à la fois sombre et lumineux, occupe toute la toile. Sur ce fond, des faisceaux de lignes noires jaillissent depuis la gauche comme des éclairs. Chaque trait est décidé, irréversible. Il n'y a pas d'hésitation, pas de retouche : les lignes sont là, définitives, une seule fois.",
      "Hartung utilisait des branches de bambou, des raclettes, des brosses de fer. Certains traits sont épais et lisses, d'autres effilés et tremblants, d'autres encore se fragmentent en fines nervures à leurs extrémités — comme des rameaux, comme des éclairs qui se ramifient avant de toucher le sol.",
  ...
  },
  {
    ...
    "ce_quon_voit": [
      "Une forme massive et sombre occupe presque toute la toile. Elle est noire au centre, et ses bords luisent d'un éclat doré et argenté là où les feuilles de métal ont été travaillées à la pointe. La forme pointe vers la gauche — une proue, une falaise, quelque chose qui avance vers l'inconnu.",
      "Le fond est d'un blanc cassé, froid, minéral — comme de la neige ou de la roche calcaire. Aucune figure humaine, aucun paysage reconnaissable. Juste cette forme noire et ses reflets métalliques. Mais quelque chose évoque des paysages nordiques : les fjords, la banquise, les falaises de basalte qui tombent dans l'océan Arctique.",
