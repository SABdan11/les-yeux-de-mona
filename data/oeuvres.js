const OEUVRES = [
  ...
  },
  {
    ...
    "ce_quon_voit": [
      ...
      "Regardez les mots barrés. Basquiat barrait les mots pour montrer qu'on peut les dire tout en les contestant — pour montrer que même les vérités officielles méritent d'être interrogées. Les mots barrés ne disparaissent pas : ils restent visibles, mais marqués d'un doute.",
      "La couronne est omniprésente dans l'œuvre de Basquiat. C'est à la fois une couronne de roi, une auréole de saint, et une couronne de barbelés. Elle désigne ceux que la société couronne de gloire et ceux qu'elle couronne d'épines. Basquiat se peignait souvent couronné — lui, le fils d'immigrés haïtiens devenu en quelques années l'artiste le plus cher d'Amérique."
    ],
  ...
  },
  {
    ...
    "ce_quon_voit": [
      "Pour entrer, il faut passer une petite porte ronde taillée dans le réservoir en bois. L'espace intérieur est sombre, bas de plafond, légèrement oppressant — comme l'intérieur d'une cave ou d'un ventre. Au centre, un petit lit en fer forgé noir. Autour et au-dessus, des fioles en verre de toutes tailles, suspendues ou posées, contenant des liquides translucides. Des vêtements d'enfant pendent du plafond comme des fantômes textiles.",
      "Les liquides dans les fioles sont symboliques : des larmes, de la sueur, du sang, de l'urine. Les fluides du corps que l'on cache, que l'on retient. Bourgeois les rassemble, les préserve, les expose dans du verre — comme des reliques, comme des preuves. Elle disait que ses peurs les plus profondes étaient liquides : l'abandon, la dissolution, la disparition.",
      "Sur le plancher en bois, de l'eau. Le reflet des fioles et des vêtements se démultiplie dans cette surface miroir. L'espace entier est une mémoire — une reconstitution de quelque chose d'enfoui, de précieux parce que douloureux. En sortant, on lit l'inscription sur le couvercle : « L'art est une garantie de sanité mentale. »"
    ],
  ...
  },
  {
    ...
    "ce_quon_voit": [
      "Ce qu'on voit ici n'est pas la performance elle-même — elle a eu lieu en 1998 et n'existe plus. Ce qu'on voit, c'est sa trace : des photographies grand format et des vidéos qui montrent Abramović dans différentes postures. Immobile, debout, les yeux ouverts. Marchant à un rythme imperceptiblement lent. Assise face au vide, face à nous.",
      "Dans une des séquences, Abramović reste assise sur une chaise, parfaitement immobile, pendant des heures. Le public entre, tourne autour d'elle, repart. Elle ne réagit pas, ne cligne presque pas des yeux. Son visage est serein — pas tendu, pas douloureux, juste présent.",
      "Ces performances sont une pratique de la présence pure : être là, complètement, sans distractions. Au MoMA de New York en 2010, elle s'est assise 736 heures face au public — et des milliers de personnes sont venues s'asseoir en silence face à elle, et beaucoup ont pleuré sans savoir pourquoi."
    ],
  ...
  },
  {
    ...
    "ce_quon_voit": [
      "Une toile immense — deux mètres de hauteur, deux mètres vingt de largeur. Elle est entièrement noire. Mais dès qu'on se déplace, quelque chose se met à vivre dans ce noir. Des stries horizontales et verticales, creusées à la spatule dans l'acrylique épais, captent la lumière de la salle différemment selon l'angle : certaines zones brillent d'un éclat presque métallique, d'autres restent dans une obscurité mate.",
      "Bougez lentement devant la toile. Regardez comment les zones lumineuses et sombres se déplacent avec vous. Ce tableau n'est pas le même d'un côté de la salle et de l'autre. Il n'est pas le même le matin avec la lumière naturelle et le soir sous les spots artificiels. Soulages disait que ses toiles sont des pièges à lumière — non pas pour l'absorber, mais pour la transformer.",
      "Le titre indique la date exacte — 22 avril 2002. Pas un titre poétique, pas un numéro de série : une date de naissance. Ce tableau a eu lieu quelque part, dans l'atelier de Soulages à Paris, un lundi d'avril. Et depuis ce jour, il vit de la lumière que lui donnent les salles où il est exposé."
    ],
