const OEUVRES = [
  ...
  },
  {
    ...
    "frise_desc": "Les expressionnistes abstraits américains font du geste lui-même l'œuvre. Le corps du peintre s'engage totalement dans la toile — elle est posée à plat sur le sol, et la peinture y est projetée, coulée, drippée depuis les hauteurs. Ce n'est plus une image : c'est une trace.",
    "salle": "Niveau 4, galerie Action Painting",
    "image": "images/pollock.png",
    "description_academique": "Jackson Pollock (1912–1956) est la figure centrale de l'Action Painting américaine. À partir de 1947, il développe la technique du dripping : la toile est posée à plat sur le sol, et Pollock la parcourt en tous sens, projetant la peinture depuis des bâtons, des pinceaux, des couteaux — sans jamais toucher la surface. Cette peinture de 1948 est l'une des premières grandes œuvres de sa période « classique » : une toile monumentale saturée d'entrelacs argentés sur fond noir, blanc, jaune et rouge, née de plusieurs heures de danse physique autour de la toile.",
    "ce_quon_voit": [
      "Une toile immense, presque carrée, d'environ un mètre cinquante de côté. Le premier regard est désorienté : il n'y a rien à saisir, pas de centre, pas de bord, pas de figure. Juste un réseau dense de lignes qui se croisent, s'entrelacent, se recouvrent. Des fils d'argent brillant courent sur un fond de traînées noires, blanches, jaunes et rouges.",
      "Approchez-vous. Les lignes ne sont pas peintes au pinceau : elles ont été projetées, coulées, drippées. Certaines sont fines comme un cheveu, d'autres épaisses comme un doigt. Certaines tremblent, d'autres s'élancent droites sur dix centimètres avant de se tordre. Ici, une gerbe d'éclats. Là, une spirale qui se défait. Et partout, sous les fils d'argent, les couches antérieures — du noir posé en premier, puis du blanc, puis des jets de rouge et de jaune, et par-dessus tout ça l'argent qui unifie le chaos.",
      "Pollock travaillait seul, la nuit, en musique — souvent du jazz ou du jazz bebop. Il marchait autour de la toile, s'accroupissait, se redressait, lançait la peinture depuis différentes hauteurs. L'œuvre n'est pas le résultat d'une idée préalable : elle est le résidu d'un acte. Une trace de corps, de mouvement, d'énergie dépensée. Pollock disait qu'il était dans le tableau quand il peignait — qu'il n'y avait plus de séparation entre lui et la toile."
    ],
    "lecon_titre": "Lâche-prise",
    "lecon_texte": "Pollock a découvert que les meilleures choses qu'il faisait arrivaient quand il arrêtait de contrôler. Pas quand il décidait à l'avance ce qu'il allait peindre, mais quand il se laissait emporter par le mouvement, la musique, l'instant. Lâcher le contrôle ne veut pas dire s'abandonner au hasard : ça veut dire faire confiance à ce qui est en toi, au-dessous de la pensée consciente. Parfois, la meilleure façon de réussir quelque chose est d'arrêter d'essayer de le contrôler et de laisser le faire.",
    "lecon_mot_cle": "les forces profondes en toi savent ce qu'elles font — laisse-les agir",
    ...
    "grandparent_questions": [
      ...
      "« Pollock écoutait du jazz en peignant. Est-ce que tu penses que ça s'entend dans le tableau ? »",
      "« Si tu devais faire pareil — projeter de la peinture depuis un bâton sur une toile par terre — qu'est-ce que tu ressentirais, tu crois ? »"
    ],
    "grandparent_conseil": "Cherchez ensemble les différentes couches de couleurs : le noir en dessous, puis le blanc, puis le rouge et le jaune, puis l'argent par-dessus. On voit que Pollock revenait plusieurs fois sur la toile. Et regardez les bords : la peinture déborde parfois, ne respecte pas le cadre. Pour Pollock, la toile n'avait pas de limite — elle continuait dans toutes les directions.",
    "mot_mystere_mot": "Le dripping",
    "mot_mystere_texte": "Le dripping — de l'anglais to drip, « goutter » — est une technique inventée par Jackson Pollock vers 1947 qui consiste à projeter ou laisser couler la peinture sur une toile posée à plat, sans jamais toucher directement la surface. La peinture tombe, coule, éclate, selon la hauteur depuis laquelle elle est jetée et la viscosité du produit. Le dripping permet des effets impossibles au pinceau traditionnel — des entrelacs d'une finesse extrême, des éclaboussures aléatoires, des superpositions de gestes successifs. Le critique Harold Rosenberg appela ce mouvement l'Action Painting : pour lui, la toile n'était plus une surface à décorer, mais une arène dans laquelle l'artiste agissait.",
    "anecdote": "En 1950, le photographe Hans Namuth passa des mois à photographier et filmer Pollock en train de peindre. Ces images — l'artiste marchant pieds nus autour de sa toile, cigarette aux lèvres, projetant la peinture depuis tous les angles — firent le tour du monde et donnèrent à Pollock le statut d'icône. Mais Pollock détestait être observé. Le jour où Namuth termina son film, Pollock brisa sa longue sobriété et se remit à boire. Il mourut six ans plus tard dans un accident de voiture, à quarante-quatre ans. On retrouva dans les décombres une bouteille vide à ses pieds."
  },
  {
    "id": 43,
    "musee": "pompidou",
    ...
    "frise_desc": "Les Nouveaux Réalistes — Tinguely, Klein, Niki de Saint Phalle — s'emparent du monde réel comme matière première. Ils intègrent des objets du quotidien dans leurs œuvres et font exploser la frontière entre l'art et la vie.",
    "salle": "Niveau 4, galerie Nouveau Réalisme",
    "image": "images/nikisaintphalle.png",
    "description_academique": "Niki de Saint Phalle (1930–2002) est l'une des artistes féministes les plus importantes du XXe siècle. La Mariée (1963) est une figure monumentale entièrement blanche, composée d'un assemblage de poupées, de jouets, de fleurs en plastique et d'objets hétéroclites pris dans un grillage recouvert de plâtre peint. L'œuvre interroge avec une ironie cinglante le destin féminin préfabriqué — la mariée parfaite et silencieuse — tout en portant en elle les traces d'une violence intérieure qui cherche à éclater. Cette même année 1963, Niki de Saint Phalle réalisait ses premières « Tirs » : des tableaux contenant des sacs de peinture, que le public était invité à perforer à coups de fusil.",
    "ce_quon_voit": [
      "Une silhouette blanche immense — plus grande qu'un homme — se dresse dans la salle. Au premier regard, c'est une mariée : la robe blanche volumineuse, la forme générale d'une femme le jour de ses noces. Mais en s'approchant, quelque chose cloche. La surface n'est pas lisse : elle est couverte de bosses, de renflements, d'objets qui débordent sous la couche de plâtre blanc.",
      "Regardez attentivement : des poupées, des petites voitures, des fleurs de plastique, des jouets d'enfants sont pris dans le grillage et enfouis sous le blanc. Certains dépassent encore — un bras de poupée, une fleur jaune, un objet indéfini. La mariée est littéralement faite d'une accumulation de rôles, d'objets, de symboles du monde féminin traditionnel — jouets, maternité, fleurs. Tout ça est là, emmailloté, blanchi à la chaux comme pour le neutraliser.",
      "Le blanc unifie tout, efface tout, rend tout pareil. C'est une figure fantôme, une identité confisquée. Mais quelque chose résiste : les objets emprisonnés refusent de disparaître complètement, ils font des bosses sous la surface, ils débordent. Niki de Saint Phalle aimait à dire qu'elle avait été une mariée en fuite — elle avait rompu avec son milieu de la haute bourgeoisie new-yorkaise pour devenir artiste. La Mariée, c'est tout ce qu'elle avait refusé d'être."
    ],
    "lecon_titre": "Invente ta trajectoire",
    "lecon_texte": "Niki de Saint Phalle a grandi dans une famille très riche, avec un destin tout tracé : être belle, se marier bien, tenir une maison. Elle a dit non. Elle est partie. Elle a tout réinventé, au prix d'une vraie rupture. Inventer sa trajectoire, ce n'est pas fuir par caprice — c'est avoir le courage de regarder en face les rôles qu'on nous a assignés, et de décider lesquels on veut vraiment jouer. Pas tous. Pas aucun. Mais les siens.",
    "lecon_mot_cle": "le destin ne se subit pas — il se choisit, et parfois il se tire dessus",
    "grandparent_methode": "Invitez l'enfant à tourner autour de la sculpture et à chercher les objets cachés sous le blanc. Chaque objet qu'on trouve est une surprise. Puis demandez-lui : pourquoi Niki a-t-elle recouvert tout ça de blanc ? Qu'est-ce qu'on fait quand on veut effacer quelque chose ?",
    "grandparent_questions": [
      "« Tu vois des objets qui dépassent sous le blanc ? Tu en reconnais certains ? »",
      "« Pourquoi est-ce que la mariée est blanche, à ton avis — pas beige, pas rose, mais blanc pur ? »",
      "« Niki de Saint Phalle a tiré des coups de fusil sur ses tableaux. Est-ce que tu penses que c'est de l'art ? Pourquoi ? »"
    ],
    "grandparent_conseil": "Racontez à l'enfant les « Tirs » : Niki invitait le public à viser des tableaux avec un vrai fusil. Les sacs de peinture cachés dans la toile éclataient au contact des balles — rouge, bleu, jaune giclaient sur le blanc. C'était une façon de « tuer » l'art figé des musées et de laisser la violence sortir. Demandez-lui : est-ce que ça ressemble à de la colère, ou à de la joie ?",
    "mot_mystere_mot": "L'assemblage",
    "mot_mystere_texte": "L'assemblage est une technique artistique qui consiste à réunir des objets réels — des objets trouvés, des déchets, des jouets, des morceaux de vie quotidienne — pour créer une sculpture ou une œuvre en trois dimensions. Ce n'est pas de la sculpture au sens traditionnel : on ne taille pas la pierre, on ne fond pas le métal. On collecte, on empile, on fixe. Les premiers assemblages furent ceux de Kurt Schwitters dans les années 1920, qui construisait des colonnes entières avec des billets de tramway usagés, des ficelles et des vieux journaux. Niki de Saint Phalle va plus loin : ses assemblages ont une intention narrative et critique. Chaque objet qu'elle choisit veut dire quelque chose.",
    "anecdote": "Niki de Saint Phalle n'avait aucune formation artistique quand elle a commencé à peindre, à vingt-deux ans, dans un hôpital psychiatrique où elle se soignait pour une dépression sévère. Les médecins lui avaient conseillé de dessiner pour extérioriser ses émotions. Elle n'avait jamais tenu un pinceau. Mais quelque chose d'incontrôlable était sorti. À la fin de sa vie, elle avait réalisé le Jardin des Tarots, un parc monumental en Toscane peuplé de sculptures gigantesques inspirées du tarot — et elle vivait elle-même à l'intérieur de l'une d'elles, la Grande Prêtresse, dont les seins étaient aménagés en chambre à coucher."
  },
  {
    "id": 44,
    "musee": "pompidou",
    ...
    "frise_desc": "Les artistes de l'abstraction lyrique européenne font confiance au geste spontané — la tache, le trait fulgurant, l'empreinte directe du corps sur la toile. Contre le calcul et la raison, ils cherchent l'instantané, l'irréversible, la trace vivante.",
    "salle": "Niveau 4, galerie Abstraction lyrique",
    "image": "images/hartung.png",
    "description_academique": "Hans Hartung (1904–1989), né à Leipzig, est l'un des pionniers de l'abstraction lyrique européenne. Réfugié en France, engagé dans la Légion étrangère, blessé en 1944 et amputé de la jambe droite, il développe après la guerre une peinture de gestes fulgurants : de grands faisceaux de lignes noires, tracés en quelques secondes depuis des branches de bambou, griffent des fonds colorés lumineux. T 1964-H45 est l'une de ses œuvres les plus frappantes : des traits noirs explosive s'élancent sur un fond d'un bleu-gris profond et serein.",
    "ce_quon_voit": [
      "Un fond bleu-gris, à la fois sombre et lumineux, occupe toute la toile. Sur ce fond, des faisceaux de lignes noires jaillissent depuis la gauche comme des éclairs — ou comme des griffures. Chaque trait est décidé, irréversible. Il n'y a pas d'hésitation, pas de retouche : les lignes sont là, définitives, une seule fois.",
      "Regardez la texture des traits noirs. Ils ne sont pas peints au pinceau ordinaire : Hartung utilisait des branches de bambou, des raclettes, des brosses de fer. Certains traits sont épais et lisses, d'autres effilés et tremblants, d'autres encore se fragmentent en fines nervures à leurs extrémités — comme des rameaux, comme des éclairs qui se ramifient avant de toucher le sol.",
      "La tension entre le fond bleu-gris calme et les traits noirs fulgurants est au cœur du tableau. Le fond est là depuis longtemps, serein, profond. Les traits arrivent en quelques secondes et tout bascule. C'est l'image de l'irruption — de quelque chose qui surgit et laisse une trace durable dans un monde qui semblait tranquille."
    ],
    "lecon_titre": "Laisse une trace",
    "lecon_texte": "Hartung peignait en quelques secondes des gestes qui prennaient des années à préparer. Ces secondes-là ne pouvaient pas être refaites, corrigées, améliorées. Elles étaient là ou pas. Laisser une trace, c'est accepter que certains moments sont uniques et irréversibles — et que c'est précisément pour ça qu'ils valent quelque chose. Une parole dite avec courage, un acte décidé sans filet, un choix qu'on ne peut pas défaire : ce sont nos propres T 1964. Nos griffures sur le fond bleu du monde.",
    "lecon_mot_cle": "certains gestes n'ont de valeur que parce qu'ils sont irréversibles",
    "grandparent_methode": "Demandez à l'enfant de regarder les traits noirs et d'imaginer comment Hartung les a faits — vite ou lentement ? D'une main ou de plusieurs ? Puis expliquez que Hartung avait une jambe artificielle depuis la guerre, et qu'il peignait debout, en se déplaçant d'un bout à l'autre de la toile. Demandez : est-ce que ça change quelque chose de savoir ça ?",
    "grandparent_questions": [
    ...
    "grandparent_conseil": "Regardez ensemble les extrémités des traits — là où ils se ramifient, se fragmentent, s'effilochent. C'est là que le geste s'épuise et laisse place au fond. Hartung appelait ça « le moment où le geste se donne ». Et cherchez le seul endroit où le fond bleu est totalement libre, sans aucun trait — c'est le centre bas de la toile. Comme un espace qui respire.",
    "mot_mystere_mot": "Le tachisme",
    "mot_mystere_texte": "Le tachisme — du français tache — est un mouvement artistique européen des années 1950, équivalent de l'expressionnisme abstrait américain. Les tachistes peignent par taches, par gestes spontanés, sans dessiner à l'avance. Le geste physique du peintre — sa vitesse, son élan, sa pression — devient le sujet même du tableau. Le tachisme partage avec l'Action Painting américaine la conviction que l'art doit être un acte vivant, pas une production calculée. Mais là où Pollock danse autour d'une toile posée au sol, Hartung reste debout face à une toile verticale et frappe — comme un calligraphe japonais, dont il s'inspirait.",
    "anecdote": "En 1944, Hans Hartung combattait dans la Légion étrangère pour libérer la France — lui, l'Allemand qui avait fui le nazisme. Blessé par des éclats d'obus dans les derniers mois de la guerre, il perdit sa jambe droite. On lui accorda la nationalité française à l'hôpital, en reconnaissance de son engagement. Il avait tout sacrifié à sa conviction : son pays natal, sa jambe, des années de sa vie. À quatre-vingt-cinq ans, incapable de se tenir debout, il continuait à peindre depuis son fauteuil roulant, en projetant la peinture avec des souffles d'air comprimé. Son dernier tableau fut achevé le jour de sa mort."
  },
  {
    "id": 45,
    "musee": "pompidou",
    ...
    "frise_desc": "Des artistes comme Bergman cherchent dans la matière elle-même — métal, sable, pigment épais — une présence qui dépasse la peinture et touche au minéral, au géologique, à l'élémentaire.",
    "salle": "Niveau 4, galerie Abstraction lyrique",
    "image": "images/bergman.png",
    "description_academique": "Anna-Eva Bergman (1909–1987), née en Norvège, est l'une des grandes figures de l'abstraction européenne d'après-guerre, longtemps éclipsée par son mari Hans Hartung dont elle avait partagé la vie et l'exil. Elle développe une peinture de grandes formes géométriques simples — proues, astres, monolithes — rehaussées de feuilles de métal (or, argent, cuivre) collées sur la toile et travaillées à la pointe, créant des surfaces qui captent et redistribuent la lumière ambiante. Proue noire (1964) est l'une de ses œuvres les plus saisissantes : une forme sombre monumentale qui s'avance dans l'espace comme la proue d'un navire ou une falaise au bord du vide.",
    "ce_quon_voit": [
      "Une forme massive et sombre occupe presque toute la toile. Elle est noire au centre, et ses bords luisent d'un éclat doré et argenté là où les feuilles de métal ont été travaillées à la pointe. La forme pointe vers la gauche — une proue, une falaise, quelque chose qui avance vers l'inconnu. Elle semble peser des tonnes et, en même temps, flotter.",
      "Le fond est d'un blanc cassé, froid, minéral — comme de la neige ou de la roche calcaire. Aucune figure humaine, aucun paysage reconnaissable. Juste cette forme noire et ses reflets métalliques. Mais quelque chose dans cette abstraction totale évoque des paysages nordiques : les fjords, la banquise, les falaises de basalte qui tombent dans l'océan Arctique.",
      "Approchez-vous du bord doré de la forme. Les feuilles de métal ont été froissées, incisées, égratignées à la pointe — chaque marque capte la lumière différemment selon l'angle. La surface est vivante, changeante. Ce qui était sombre de loin scintille de près. Bergman appelait ses métaux « la lumière prisonnière de la matière »."
    ],
    "lecon_titre": "Affronte l'inconnu",
    "lecon_texte": "La proue d'un navire, c'est la partie qui s'avance en premier dans l'obscurité — avant tout le reste. Avant le gouvernail, avant les voiles, avant les gens. Elle est la première à toucher la tempête, à fendre l'inconnu. Bergman a grandi dans les paysages nordiques — des espaces où le ciel et la mer se confondent et où l'horizon n'est jamais certain. Affronter l'inconnu ne veut pas dire ne pas avoir peur : ça veut dire avancer quand même, comme la proue noire, avec ses reflets d'or sur ses bords.",
    "lecon_mot_cle": "la beauté se trouve toujours au bord de l'inconnu",
    "grandparent_methode": "Invitez l'enfant à s'approcher très près des bords dorés et argentés de la forme noire, puis à reculer jusqu'à voir l'ensemble. L'œuvre change totalement selon la distance et la lumière. C'est une œuvre qui se donne en plusieurs fois, à plusieurs vitesses.",
    "grandparent_questions": [
      "« Qu'est-ce que cette forme te fait penser — un navire, une montagne, une baleine, autre chose ? »",
      "« Les bords brillent d'or et d'argent alors que le centre est noir. Qu'est-ce que ça dit, selon toi, sur les bords des choses ? »",
      "« Si tu étais la proue d'un navire, vers quoi est-ce que tu avancerais ? »"
    ],
    "grandparent_conseil": "Cherchez ensemble la façon dont la lumière de la salle se réfléchit dans les feuilles de métal : selon l'angle où vous vous placez, la forme noire change. Bergman collait les feuilles d'or et d'argent elle-même, les froissait à la main, les incisait à la pointe. Ses œuvres sont différentes le matin et le soir, selon la lumière naturelle ou artificielle. Elles vivent avec le temps.",
    "mot_mystere_mot": "La feuille de métal",
    "mot_mystere_texte": "La feuille de métal — feuille d'or, d'argent ou de cuivre — est une technique ancienne utilisée depuis l'Antiquité pour dorer les cadres, les icônes religieuses, les plafonds des palais. Elle est obtenue en martelant un métal précieux jusqu'à l'amener à une finesse extrême — parfois moins d'un millième de millimètre. Anna-Eva Bergman s'en empare dans les années 1950 non pour dorer des objets, mais pour créer des surfaces qui vivent de la lumière ambiante. En froissant et incisant ces feuilles sur ses toiles, elle obtient des effets impossibles avec la peinture seule : des éclats changeants, des ombres profondes dans la matière elle-même. Ses œuvres ne sont pas éclairées de l'extérieur — elles génèrent leur propre lumière.",
    "anecdote": "Anna-Eva Bergman et Hans Hartung formaient l'un des couples les plus singuliers de l'art du XXe siècle. Ils s'étaient mariés deux fois — la première fois en 1929, puis de nouveau en 1952 après avoir divorcé et chacun vécu une autre vie. Pendant des années, Bergman fut surtout connue comme « la femme de Hartung ». Ce n'est qu'après sa mort que son œuvre fut réévaluée et qu'elle prit la place qui lui revient dans l'histoire de l'art. Ils sont enterrés côte à côte en Provence, dans une maison qu'ils avaient construite et qui est aujourd'hui une fondation. Sur la tombe de Bergman : une feuille de métal frappée à l'or."
  },
  {
    "id": 46,
    "musee": "pompidou",
    ...
    "frise_desc": "Basquiat et les artistes néo-expressionnistes rejettent le minimalisme froid des années 1970 et ramènent la figure humaine, la couleur violente et la narration urgente dans l'art. Basquiat vient de la rue, du graffiti, du hip-hop — et il entre dans les musées comme une bombe.",
    "salle": "Niveau 4, galerie Néo-expressionnisme",
    "image": "images/basquiat.png",
    "description_academique": "Jean-Michel Basquiat (1960–1988), né à Brooklyn de père haïtien et de mère portoricaine, commence par couvrir les murs de New York de ses graffitis signés SAMO© avant d'entrer fulgurant dans le monde de l'art à vingt ans. Ses toiles mêlent graffitis, mots barrés, anatomies schématiques, couronnes de roi et références à l'histoire noire américaine, au jazz, à la boxe et à la mythologie. Ce tableau de 1982 est une œuvre de sa période la plus intense : une figure totémique aux yeux grands ouverts, couronnée, surgit d'un fond saturé de textes, de symboles et de couleurs criardes.",
    "ce_quon_voit": [
      "La première impression est celle d'une explosion : des couleurs criardes — rouge, jaune, vert, noir — partout à la fois. Des mots écrits en grandes lettres, parfois barrés d'un trait. Des schémas anatomiques rapides — des os, un crâne, un corps décharné. Et au centre, une tête : des yeux ronds et grands ouverts, une couronne de trois pointes posée sur des cheveux hérissés.",
      "Regardez les mots. Certains sont lisibles — des noms, des dates, des références au jazz ou à la boxe. D'autres sont barrés, recouverts, mis entre guillemets ou entre crochets. Basquiat barrait les mots pour montrer qu'on peut les dire tout en les contestant — pour montrer que même les vérités officielles méritent d'être interrogées. Les mots barrés ne disparaissent pas : ils restent visibles, mais marqués d'un doute.",
      "La couronne est omniprésente dans l'œuvre de Basquiat. C'est à la fois une couronne de roi, une auréole de saint, et la couronne de barbelés. Elle désigne ceux que la société couronne de gloire et ceux qu'elle couronne d'épines. Basquiat se peignait souvent couronné — lui, le fils d'immigrés haïtiens, devenu en quelques années l'artiste le plus cher d'Amérique."
    ],
    "lecon_titre": "Hurle ta vérité",
    "lecon_texte": "Basquiat n'a pas demandé la permission d'entrer dans les musées. Il a peint sur les murs de New York jusqu'à ce que les musées viennent le chercher. Hurler sa vérité, ce n'est pas crier pour faire du bruit — c'est refuser que ce qu'on pense et ce qu'on vit reste invisible. Basquiat peignait pour que les corps noirs, les histoires effacées, les noms barrés par l'histoire officielle existent dans les musées au même titre que les rois et les dieux de la Renaissance. Sa couronne, c'est la même que celle de Botticelli — mais portée par quelqu'un qu'on ne s'attendait pas à voir là.",
    "lecon_mot_cle": "être visible est un acte politique — et parfois un acte de survie",
    "grandparent_methode": "Invitez l'enfant à chercher les mots barrés dans le tableau — combien en voit-il ? Puis demandez-lui pourquoi Basquiat ne les a pas effacés complètement. Expliquez que barrer un mot, c'est une façon de le dire deux fois : une fois normalement, une fois en contestation.",
    "grandparent_questions": [
      ...
      "« Il y a des mots barrés dans le tableau. Est-ce que tu arrives à en lire certains ? Pourquoi les barrer plutôt que les effacer ? »"
    ],
    "grandparent_conseil": "Cherchez ensemble les schémas anatomiques — les os, les crânes, les organes dessinés grossièrement. Basquiat avait appris l'anatomie dans un livre médical que sa mère lui avait offert quand il était enfant et qu'il avait été renversé par une voiture. Ces schémas d'os reviennent tout au long de son œuvre — une façon de rappeler que sous la peau de tous les hommes, le squelette est le même.",
    "mot_mystere_mot": "Le graffiti",
    "mot_mystere_texte": "Le mot graffiti vient de l'italien graffito, « griffonné ». C'est une inscription ou un dessin tracé sur un mur ou une surface publique sans autorisation. Les graffitis existent depuis l'Antiquité — les murs de Pompéi en sont couverts. Mais le graffiti moderne, tel qu'il apparaît à New York dans les années 1970, est d'abord une façon pour les jeunes des quartiers défavorisés — souvent noirs et latinos — de s'inscrire dans l'espace public dont ils sont habituellement exclus. SAMO©, le tag de Basquiat, signifiait Same Old Shit — « toujours la même merde » : un commentaire sarcastique sur une société qui répète ses injustices. En quelques années, ce geste de survie devint un mouvement artistique mondial.",
    "anecdote": "En 1982, à vingt-deux ans, Jean-Michel Basquiat gagnait déjà plus d'un million de dollars par an. Il vivait dans un loft à Manhattan, avait Warhol comme ami et mentor, et était invité aux plus grandes foires d'art internationales. Mais il dormait souvent sur les canapés de ses amis ou dans son atelier, refusait de signer des baux, et achetait des centières de paires de chaussures qu'il laissait n'importe où. Il mourut d'une overdose à vingt-sept ans, la même année qu'Andy Warhol mourait d'une opération. On retrouva dans son atelier des milliers de dessins épars, des livres annotés, des cassettes de jazz. Une œuvre qui avait tout dit en moins de dix ans."
  },
  {
    "id": 47,
    "musee": "pompidou",
    ...
    "frise_desc": "Des artistes comme Louise Bourgeois transforment les espaces d'exposition en environnements immersifs qui parlent du corps, de la mémoire, de la peur et du désir. L'œuvre n'est plus un objet à regarder : c'est un espace à vivre.",
    "salle": "Niveau 4, galerie Installations",
    "image": "images/bourgeois.png",
    "description_academique": "Louise Bourgeois (1911–2010), née à Paris, est l'une des sculptrices les plus importantes du XXe siècle. Elle passa la majeure partie de sa vie à New York, travaillant pendant des décennies dans une relative discrétion avant d'être redécouverte dans les années 1980. Precious Liquids (1992) est une installation immersive : un immense réservoir cylindrique en bois de chêne — comme une cuve de brasserie — d'environ trois mètres de diamètre, dans lequel sont suspendus au plafond des vêtements d'enfant et un lit en fer forgé, entourés de fioles en verre contenant des liquides corporels symboliques. Sur le couvercle en bois, une inscription : « Art is a guaranty of sanity. »",
    "ce_quon_voit": [
      "Pour entrer, il faut passer une petite porte ronde taillée dans le réservoir en bois. L'espace intérieur est sombre, bas de plafond, légèrement oppressant — comme l'intérieur d'une cave ou d'un ventre. Au centre, un petit lit en fer forgé noir. Autour et au-dessus, des fioles en verre de toutes tailles, suspendues ou posées, contenant des liquides translucides. Des vêtements d'enfant — une robe, un manteau — pendent du plafond comme des fantômes textiles.",
      "Les liquides dans les fioles sont symboliques : des larmes, de la sueur, du sang, de l'urine. Les fluides du corps que l'on cache, que l'on retient, que l'on honte de perdre. Bourgeois les rassemble, les préserve, les expose dans du verre — comme des reliques, comme des preuves, comme des offrandes. Elle disait que ses peurs les plus profondes étaient liquides : l'abandon, la dissolution, la disparition dans la matière du monde.",
      "Sur le plancher en bois, de l'eau. Le reflet des fioles et des vêtements se démultiplie dans cette surface miroir au sol. L'espace entier est une mémoire — une reconstitution de quelque chose d'enfoui, de précieux parce que douloureux. Lire l'inscription sur le couvercle en sortant : « L'art est une garantie de sanité mentale. » C'est ce que Bourgeois disait de son travail — pas une métaphore, mais une vérité littérale."
    ],
    "lecon_titre": "Transforme ta peur",
    "lecon_texte": "Louise Bourgeois avait peur depuis toujours — peur de l'abandon, peur de la douleur, peur de sa propre colère. Elle a mis soixante ans à trouver son langage artistique. Et quand elle l'a trouvé, elle a fait exactement ceci : elle a pris ses peurs, elle les a mises dans des fioles, et elle les a exposées pour que tout le monde puisse les voir. Transformer sa peur, ce n'est pas l'éliminer — c'est lui donner une forme. Lui trouver un récipient. L'art peut être ce récipient-là. L'écriture aussi. La danse. N'importe quelle forme où quelque chose d'intérieur devient visible.",
    "lecon_mot_cle": "l'art est une garantie de sanité — donner une forme à ce qui fait peur",
    "grandparent_methode": "Avant d'entrer dans l'installation, demandez à l'enfant de noter une chose qui lui fait peur. Après la visite, demandez-lui si Bourgeois avait trouvé une façon de mettre ses peurs dans un espace. Est-ce que ça les rend moins effrayantes ou plus effrayantes ?",
    "grandparent_questions": [
    ...
    "grandparent_conseil": "Lisez ensemble l'inscription sur le couvercle : « Art is a guaranty of sanity. » Expliquez à l'enfant que Bourgeois a dit cette phrase très sérieusement — qu'elle avait subi des traumatismes graves dans son enfance et que l'art était sa façon de ne pas sombrer. Puis demandez-lui ce qu'il ferait, lui, pour ne pas sombrer dans les moments difficiles.",
    "mot_mystere_mot": "L'installation",
    "mot_mystere_texte": "Une installation est une œuvre d'art conçue pour un espace spécifique, que le visiteur traverse et expérimente de l'intérieur. Contrairement à une sculpture ou à un tableau qu'on regarde de l'extérieur, une installation transforme l'espace lui-même en œuvre — ses dimensions, ses sons, sa lumière, ses odeurs font partie de l'œuvre. Le spectateur n'est pas devant l'art : il est dedans. Les premières installations apparaissent dans les années 1960, souvent liées à l'art conceptuel et au minimalisme. Louise Bourgeois en fait un instrument de mémoire et d'autobiographie : chaque installation est une chambre intérieure rendue habitable, un espace mental rendu concret.",
    "anecdote": "Louise Bourgeois a créé ses œuvres les plus célèbres après soixante-dix ans. La Tate Modern de Londres lui commanda une installation pour l'inauguration de sa Turbine Hall en 2000 : elle avait quatre-vingt-neuf ans. Elle livra Maman — une araignée en acier de neuf mètres de haut, sur huit pattes, avec un sac d'œufs en marbre suspendu sous son abdomen. Bourgeois disait que sa mère était comme une araignée : protectrice, patiente, tisseuse de liens. Maman est aujourd'hui la sculpture la plus exposée au monde — il en existe plusieurs exemplaires dans les plus grands musées et places publiques. Bourgeois mourut à quatre-vingt-dix-huit ans, dans son atelier de New York, entourée de ses assistants."
  },
  {
    "id": 48,
    "musee": "pompidou",
    ...
    "frise_desc": "Les artistes de la performance font de leur propre corps le matériau de l'œuvre. Ils explorent les limites de l'endurance, la présence absolue dans l'instant, la relation directe et sans médiation entre l'artiste et le public.",
    "salle": "Niveau 4, galerie Performance",
    "image": "images/abramovic.png",
    "description_academique": "Marina Abramović (1946–), née à Belgrade, est la grande figure internationale de l'art de la performance. Depuis les années 1970, elle utilise son propre corps comme matière première — le soumettant à des tests d'endurance extrêmes, à l'immobilité prolongée, à la douleur et à l'épuisement. Cette œuvre de 1998, documentée en photographies et en vidéo au Centre Pompidou, rassemble plusieurs postures corporelles prolongées inspirées des pratiques bouddhistes et chamaniques : s'asseoir en silence des heures durant, marcher extrêmement lentement, tenir une position à l'équilibre. L'œuvre interroge le rapport entre présence physique, concentration mentale et relation au public.",
    "ce_quon_voit": [
      "Ce qu'on voit ici n'est pas la performance elle-même — elle a eu lieu en 1998, et elle n'existe plus. Ce qu'on voit, c'est sa trace : des photographies grand format et des écrans vidéo qui montrent Abramović dans différentes postures. Immobile, debout, les yeux ouverts. Marchant à un rythme imperceptiblement lent. Assise face au mur, face à nous, face à rien.",
      "Dans une des séquences, Abramović reste assise sur une chaise, parfaitement immobile, pendant des heures. Le public entre, tourne autour d'elle, repart. Elle ne réagit pas, ne cligne presque pas des yeux. Son visage est serein — pas tendu, pas doulereux, juste présent. Dans une autre séquence, elle marche à une vitesse si lente qu'on ne distingue pas le mouvement — on voit seulement que sa position a changé entre deux regardsConsumer, mais pas le changement lui-même.",
      "Abramović dit que ces performances sont une pratique de la présence pure : être là, complètement, sans distractions intérieures ni extérieures. Elle les appelle des « méthodes Abramović » — des exercices qu'elle enseigne aujourd'hui dans des ateliers partout dans le monde. Au Pompidou en 2010, elle s'est assise 736 heures face au public, au MoMA de New York — des milliers de personnes sont venues s'asseoir en silence face à elle, et beaucoup ont pleuré sans savoir pourquoi."
    ],
    "lecon_titre": "Tiens bon",
    "lecon_texte": "Abramović a découvert que le corps humain peut endurer bien plus qu'on ne le croit — à condition que l'esprit reste calme et ancré. Ses performances ne sont pas des exploits sportifs : ce sont des démonstrations que la souffrance n'est pas la même chose que l'insupportable, et que tenir bon — rester présent, rester là — est une forme de liberté que personne ne peut vous prendre. Tenir bon ne veut pas dire ne pas souffrir. Ça veut dire continuer malgré.",
    "lecon_mot_cle": "la présence absolue dans l'instant est une forme de liberté",
    ...
    "grandparent_questions": [
      ...
      "« Des milliers de gens sont venus s'asseoir face à elle en silence et ont pleuré. Pourquoi, selon toi ? »",
      "« Est-ce que toi, tu serais capable de rester parfaitement immobile et silencieux pendant une heure ? Qu'est-ce que tu penses qu'il se passerait dans ta tête ? »"
    ],
    "grandparent_conseil": "Regardez ensemble une des vidéos ou photographies de la marche ultra-lente. Essayez de voir le mouvement — vous ne le verrez pas directement, mais vous verrez ses effets. Expliquez à l'enfant que les moines bouddhistes pratiquent cette marche lente comme une forme de méditation : chaque pas est un acte complet, pleinement conscient. Abramović s'est formée pendant des années dans des monastères bouddhistes en Asie.",
    "mot_mystere_mot": "La performance",
    "mot_mystere_texte": "Une performance artistique est une œuvre qui se déroule dans le temps et dans l'espace, avec le corps de l'artiste comme matériau principal. Contrairement à un tableau ou une sculpture, une performance n'existe que pendant qu'elle a lieu — elle est par essence éphémère. Ce qui reste, ce sont des traces : des photographies, des vidéos, des récits de témoins. Les premières performances artistiques apparaissent dans les années 1960, liées aux happenings de John Cage et aux expérimentations du groupe Fluxus. Pour Abramović, la performance est une pratique de la présence radicale : être là, entièrement, sans filet ni préparation visible — et laisser le temps agir.",
    "anecdote": "En 1974, à vingt-huit ans, Marina Abramović réalise sa performance la plus célèbre et la plus dangereuse : Rhythm 0. Elle pose sur une table soixante-douze objets — une rose, du miel, un fouet, des ciseaux, un scalpel, un pistolet chargé. Elle se tient debout, immobile, pendant six heures, avec une instruction pour le public : « Je suis l'objet. Pendant cette période, vous pouvez faire ce que vous voulez avec moi. » Au début, les gens lui offrent des fleurs et lui touchent doucement les mains. Trois heures plus tard, ses vêtements sont déchirés, elle porte des coupures au cou. Quelqu'un pointe le pistolet chargé sur sa tempe. Un autre le détourne. Abramović ne bouge pas. À la fin, quand elle commence à marcher vers le public, les gens fuient — honteux. Elle n'a jamais refait cette performance."
  },
  {
    "id": 49,
    "musee": "pompidou",
    ...
    "frise_desc": "Frida Kahlo invente un langage pictural unique, à la croisée de l'art populaire mexicain et du surréalisme européen, pour transformer sa souffrance physique et émotionnelle en œuvre d'art. Ses autoportraits sont des actes politiques autant qu'intimes.",
    "salle": "Niveau 5, galerie Surréalisme international",
    "image": "images/kahlo.png",
    "description_academique": "Frida Kahlo (1907–1954) est la peintre mexicaine la plus célèbre du XXe siècle. The Frame (1938) est son seul tableau acquis par un musée européen de son vivant : le Louvre le lui acheta en 1939, lors de son premier séjour en France. L'œuvre est un autoportrait entouré d'un cadre de fleurs, d'oiseaux et de motifs floraux mexicains peints directement sur le verre qui protège la plaque d'aluminium centrale. Kahlo présente ainsi deux espaces : son visage huile sur métal, et le cadre ornemental sous verre — deux surfaces, deux matières, deux niveaux de réalité qui se regardent.",
    "ce_quon_voit": [
      "Au centre, un visage. Frida Kahlo peint son visage tel qu'il est : les sourcils noirs rejoints en un seul arc épais au-dessus du nez, la légère moustache, le regard direct et sérieux. Elle ne cherche pas à s'embellir ni à se dissimuler. Ce visage vous regarde, et il ne demande pas votre approbation.",
      "Autour du portrait central, le cadre est peint directement sur le verre : des fleurs multicolores, des feuilles tropicales, deux oiseaux qui se font face. Les couleurs sont vives, chaleureuses, presque naïves — rouge, vert foncé, jaune orangé. Ce cadre fait référence aux arts populaires mexicains, aux retables votifs, aux décorations de fête. Il entoure le visage comme une auréole végétale, comme une couronne de vie.",
      "Mais regardez l'ensemble : le visage sérieux, presque sévère, et le cadre exubérant, festif. Kahlo ne se contente pas de se montrer — elle choisit le cadre dans lequel elle veut être vue. Elle dit : voilà mon visage, avec mes sourcils joints et ma moustache. Et voilà ma culture, mes racines, ma fierté mexicaine. Ce tableau est un refus catégorique de la honte."
    ],
    "lecon_titre": "Fais de ta blessure une parure",
    "lecon_texte": "Frida Kahlo avait eu la polio enfant, puis un accident de bus à dix-huit ans qui lui avait brisé la colonne vertébrale. Elle passa une grande partie de sa vie alitée, en corset, à endurer des dizaines d'opérations. Elle avait aussi des sourcils qu'on lui disait trop épais, une moustache qu'on lui disait laide, un corps qu'on lui disait abîmé. Elle en a fait des couronnes. Faire de sa blessure une parure, ce n'est pas nier la souffrance — c'est décider qu'elle ne définira pas le regard que tu portes sur toi-même.",
    "lecon_mot_cle": "porter ses différences comme une couronne, pas comme une honte",
    ...
    "grandparent_questions": [
      "« Frida Kahlo a peint elle-même le cadre autour de son portrait. Pourquoi est-ce que choisir son propre cadre est important, selon toi ? »",
      "« Elle a les sourcils joints et une légère moustache, et elle les montre. Qu'est-ce que ça dit sur elle ? »",
      "« Le Louvre lui a acheté ce tableau de son vivant. Elle était mexicaine, femme, en fauteuil roulant. Est-ce que ça te surprend qu'il soit au musée ? »"
    ],
    "grandparent_conseil": "Regardez ensemble la technique particulière : le portrait est peint sur une plaque d'aluminium, et le cadre est peint sur le verre qui la recouvre. Deux surfaces séparées, deux matières différentes. Frida crée ainsi une profondeur : le visage est comme enfermé derrière une fenêtre fleurie. Demandez à l'enfant : est-ce que la vitre la protège, ou est-ce qu'elle l'emprisonne ?",
    "mot_mystere_mot": "L'autoportrait",
    "mot_mystere_texte": "Un autoportrait est un portrait que l'artiste fait de lui-même. C'est l'un des exercices les plus anciens et les plus intimes de la peinture — Rembrandt, Dürer, Van Gogh en ont fait des dizaines tout au long de leur vie. Frida Kahlo a réalisé cinquante-cinq autoportraits sur les cent quarante-trois tableaux de sa vie entière. Elle disait : « Je me peins moi-même parce que je suis souvent seule et parce que c'est le sujet que je connais le mieux. » Ses autoportraits ne sont jamais de simples reflets : ils portent des symboles, des récits, des douleurs. Ce sont des journaux intimes peints, des manifestes politiques et des déclarations d'existence.",
    "anecdote": "En 1938, le surréaliste André Breton vit des tableaux de Frida Kahlo et déclara qu'elle était surréaliste — sans l'avoir jamais rencontrée. Kahlo répondit sèchement : « Je ne peins pas des rêves. Je peins ma réalité. » Elle détestait l'étiquette. Quand elle vint en France l'année suivante pour l'exposition organisée par Breton, elle attrapa une infection sévère et passa la moitié du séjour à l'hôpital. Elle n'aimait pas Paris. Mais c'est à Paris, en 1939, que le Louvre lui acheta The Frame — son seul tableau acquis par un musée de son vivant. Elle rentra au Mexique sans avoir dit au revoir à Breton. Elle mourut à quarante-sept ans, dans la Maison Bleue de Coyoacán où elle était née."
  },
  {
    "id": 50,
    "musee": "pompidou",
    "artiste": "Joan Mitchell",
    "dates_artiste": "1925–1992",
    "titre": "Sans titre",
    "technique": "Huile sur toile (diptyque)",
    "date": "vers 1992",
    "mouvement": "Expressionnisme abstrait — Seconde génération",
    "frise_titre": "Expressionnisme abstrait — seconde génération",
    "frise_desc": "Joan Mitchell et ses contemporains héritent de Pollock et de De Kooning mais leur répondent depuis Paris et la campagne française. Ils gardent la fureur du geste mais y ajoutent la mémoire du paysage, la couleur des saisons, la sensation d'un jardin en été.",
    "salle": "Niveau 4, galerie Expressionnisme abstrait",
    "image": "images/mitchell.png",
    "description_academique": "Joan Mitchell (1925–1992), née à Chicago, est l'une des plus grandes peintres abstraites du XXe siècle. Elle s'installe à Paris en 1959, puis à Vétheuil — dans la maison où avait vécu Claude Monet — et y reste jusqu'à sa mort. Ses grandes toiles, souvent des diptyques ou des polyptyques, sont des déflagrations de couleur qui convoquent la mémoire du paysage rural, les saisons, la lumière changeante des bords de Seine. Ce Sans titre de 1992, l'une de ses dernières œuvres, est une explosion de touches bleues, vertes et violettes sur une toile monumentale — une mémoire végétale et lumineuse peinte à quelques mois de sa mort.",
    "ce_quon_voit": [
      "Deux toiles côte à côte — un diptyque — chacune d'environ deux mètres de haut. Ensemble, elles forment un panorama de couleur : du bleu cobalt profond, du vert sombre, du violet, du blanc, et par endroits un jaune éclatant qui surgit comme un coup de lumière. Les touches sont grandes, décidées, superposées en couches épaisses.",
      "Il n'y a rien à reconnaître — pas de figure, pas de paysage lisible. Et pourtant quelque chose évoque la végétation : des formes qui retombent comme des branches, des masses sombres qui ressemblent à des feuillages, des éclairs lumineux qui traversent comme la lumière entre les feuilles. Mitchell disait qu'elle peignait ses sentiments face aux paysages, pas les paysages eux-mêmes. Ce tableau, c'est la sensation de se tenir sous un grand arbre en fin d'été, quand la lumière est déjà un peu triste.",
      "Regardez les bords des touches de peinture : certaines sont franches, nettes, posées d'un seul geste. D'autres sont effilochées, superposées, construites en plusieurs passages. On voit les couches de peinture qui se répondent — le bleu posé sur le vert, le blanc venu après sur le bleu. Mitchell peignait debout, à coups de grands bras, avec de longs pinceaux. Elle fumait et buvait en peignant, écoutait du jazz. Elle disait que chaque tableau était une conversation avec Cézanne et Monet."
    ],
    "lecon_titre": "Garde la fête en toi",
    "lecon_texte": "Joan Mitchell a peint ses derniers grands tableaux alors qu'elle était très malade, incapable de sortir de sa maison. Elle peignait les jardins de Vétheuil depuis sa fenêtre — les mêmes jardins que Monet avait peints cent ans avant elle. Elle gardait en elle la mémoire des couleurs, des saisons, de la lumière. Garder la fête en soi, ce n'est pas faire semblant d'être gai — c'est conserver quelque part, même dans les moments les plus difficiles, l'accès à ce qui est beau. Une couleur. Un souvenir. La mémoire d'un jardin en été.",
    "lecon_mot_cle": "conserver l'accès à ce qui est beau, même dans l'obscurité",
    "grandparent_methode": "Demandez à l'enfant de rester devant le tableau en silence pendant deux minutes, en cherchant à sentir quelque chose — pas à comprendre, pas à nommer, juste à ressentir. Puis demandez-lui ce que ça lui a évoqué. Comparez vos deux réponses.",
    "grandparent_questions": [
      "« Si ce tableau était une saison, ce serait laquelle ? Pourquoi ? »",
      "« Joan Mitchell vivait en France, près de la maison de Monet. Est-ce que tu penses qu'on voit quelque chose de Monet dans ce tableau ? »",
      "« Elle peignait ses sentiments face aux paysages, pas les paysages eux-mêmes. Qu'est-ce que ça change ? »"
    ],
    "grandparent_conseil": "Cherchez ensemble les coups de jaune — ils sont peu nombreux mais très intenses, et ils sautent aux yeux parmi le bleu et le vert. Mitchell disait que le jaune était la couleur du souvenir heureux. Et regardez la jonction entre les deux toiles du diptyque : est-ce qu'elles se répondent, ou est-ce qu'elles se tournent le dos ? La relation entre les deux panneaux fait partie de l'œuvre.",
    "mot_mystere_mot": "Le diptyque",
    "mot_mystere_texte": "Un diptyque est une œuvre composée de deux panneaux ou deux toiles destinés à être vus ensemble. Le mot vient du grec diptukhos, « plié en deux ». À l'origine, les diptyques étaient des œuvres religieuses — deux panneaux peints qu'on pouvait fermer comme un livre, servant d'autels portatifs. Dans l'art moderne, le diptyque devient une façon d'explorer la relation entre deux espaces, deux temps, deux états. Joan Mitchell aimait les diptyques parce qu'ils créaient une respiration : deux toiles qui dialoguent, qui se répondent, qui s'éloignent. Comme deux phrases dans une conversation. Comme deux moments d'un même jour.",
    "anecdote": "Joan Mitchell avait été refusée par les galeries new-yorkaises dans les années 1950, au prétexte qu'elle était une femme. Ses grands formats — des toiles de deux ou trois mètres — étaient jugés trop « ambitieux » pour une femme peintre. Elle s'installa à Paris et ne revint jamais vivre en Amérique. À Vétheuil, elle avait un immense atelier dans lequel elle pouvait travailler à quatre ou cinq toiles en même temps. Elle ne vendait presque rien de son vivant — elle voulait garder ses tableaux autour d'elle, comme une famille. À sa mort, en 1992, sa fondation se retrouva avec des centaines d'œuvres. Aujourd'hui, ses toiles se vendent des dizaines de millions de dollars."
  },
  {
    "id": 51,
    "musee": "pompidou",
    ...
    "frise_desc": "Des artistes comme Boltanski font de la mémoire leur matière première. En rassemblant des archives, des photographies, des objets ordinaires, ils construisent des monuments aux anonymes et interrogent ce qui reste d'une vie quand tout le reste a disparu.",
    "salle": "Niveau 4, galerie Art conceptuel",
    "image": "images/boltanski.png",
    "description_academique": "Christian Boltanski (1944–2021) est l'un des artistes français les plus importants de la seconde moitié du XXe siècle. Né à Paris d'un père juif ukrainien caché sous les planchers pendant l'Occupation, il fait de la disparition, de la mémoire et de l'identité les thèmes centraux de son œuvre. La vie impossible de Christian Boltanski (1971) est l'une de ses premières installations : un empilement de boîtes de biscuits en fer rouillées, surmontées et entourées de photographies de son enfance et de lampes qui les éclairent comme des icônes ou des autels. Un texte l'accompagne : une autobiographie entièrement inventée, pleine d'incohérences et d'impossibilités.",
    "ce_quon_voit": [
      "Des boîtes de biscuits en métal, rouillées et empilées jusqu'à une certaine hauteur. Chaque boîte porte une étiquette écrite à la main — des dates, des noms, des lieux. Entre elles et autour, des photographies noir et blanc floues : un enfant, une famille, des visages indistincts. De petites lampes à incandescence les éclairent depuis des câbles électriques apparents — une lumière jaune, chaude, vacillante comme des bougies.",
      "Les photos sont volontairement floues — Boltanski les a fotografiées et re-fotografiées jusqu'à ce que les visages deviennent presque méconnaissables. Il ne voulait pas montrer des gens précis : il voulait montrer l'idée d'une enfance, la silhouette générique d'un souvenir. Ces photographies pourraient être les vôtres. Ces boîtes pourraient contenir vos propres reliques.",
      "Le texte qui accompagne l'installation est une autobiographie truffée de mensonges : Boltanski y raconte qu'il est né dans dix villes différentes, qu'il a eu des parents qui n'ont pas pu exister en même temps. Cette vie est impossible — d'où le titre. Elle est aussi universelle : une vie faite de fragments contradictoires, de souvenirs incertains, d'identités multiples. Boltanski interroge : qu'est-ce qui reste vraiment d'une vie ? Quelques boîtes. Quelques photos floues. Et des lampes qui finissent par s'éteindre."
    ],
    "lecon_titre": "Chéris les traces des invisibles",
    "lecon_texte": "Boltanski pensait aux millions de gens qui ont existé et dont il ne reste rien — aucune photo, aucun nom dans les livres d'histoire, aucune trace dans les musées. Ces gens ont aimé, souffert, ri, eu peur. Et puis tout a disparu. Ses boîtes de biscuits rouillées sont des monuments à ces invisibles. Chérir les traces des invisibles, c'est se souvenir que l'histoire n'est pas seulement faite de rois et de batailles. Elle est faite de gens ordinaires dont le souvenir s'efface, et qu'il faut parfois reconstruire avec des photos floues et des boîtes en fer.",
    "lecon_mot_cle": "chaque vie ordinaire mérite un monument",
    ...
    "grandparent_conseil": "Regardez ensemble les petites lampes qui éclairent les photos comme des bougies d'autel. Boltanski s'inspirait des synagogues et des iglises où des lumières brûlent en permanence pour les morts. Ces lampes font partie de l'œuvre — et elles s'usent et s'éteignent avec le temps. Demandez à l'enfant : est-ce que l'œuvre change quand une lampe s'éteint ?",
    "mot_mystere_mot": "La relique",
    "mot_mystere_texte": "Une relique, à l'origine, est un objet ayant appartenu à un saint ou contenant un fragment de son corps, conservé comme objet de dévotion dans une église. Mais dans un sens plus large, une relique est n'importe quel objet matériel qui conserve la trace d'une présence disparue. Une lettre, une photographie, une boîte de biscuits vide qui a appartenu à quelqu'un : ces objets ordinaires deviennent des reliques quand quelqu'un décide de les conserver et de leur accorder une valeur. Boltanski fait exactement cela : il prend des objets sans valeur marchande — des boîtes de biscuits, des photos floues — et les expose dans un musée comme des reliques précieuses. Ce faisant, il pose la question : qu'est-ce qui mérite d'être conservé ? Et qui décide ?",
    "anecdote": "Christian Boltanski avait coutume de dire qu'il vendait aussi son temps. À partir de 2010, un collectionneur japonais lui paya une rente mensuelle en échange du droit de diffuser en direct sur Internet le son de ses battements de cœur — vingt-quatre heures sur vingt-quatre, sept jours sur sept. Le contrat stipulait qu'après la mort de Boltanski, l'enregistrement de ses battements de cœur continuerait à être diffusé pour toujours. Boltanski mourut en 2021. Quelque part sur un serveur en Islande, son cœur bat encore."
  },
  {
    "id": 52,
    "musee": "pompidou",
    ...
    "frise_desc": "Pierre Soulages invente l'Outrenoir : non pas le noir qui absorbe la lumière, mais le noir qui la réfléchit et la transforme. Ses grandes toiles noires bougent selon la lumière de la salle et l'angle du regard — elles vivent.",
    "salle": "Niveau 4, galerie Soulages",
    "image": "images/soulages.png",
    "description_academique": "Pierre Soulages (1919–2022) est le plus grand peintre français vivant du XXe siècle. Né à Rodez, dans l'Aveyron, il commence à peindre en noir dès l'enfance. À partir de 1979, il fait la découverte qui fonde toute la suite de son œuvre : le noir peut être une source de lumière. En travaillant la surface noire en stries et en reliefs, il obtient des effets de lumière réfléchie qui changent selon l'angle et l'intensité de l'éclairage ambiant. Il appelle cela l'Outrenoir — « au-delà du noir ». Cette toile de 2002, deux mètres sur deux mètres vingt, est l'une des œuvres les plus importantes de sa maturité.",
    "ce_quon_voit": [
      "Une toile immense — deux mètres de hauteur, deux mètres vingt de largeur. Elle est entièrement noire. Mais dès qu'on se déplace, dès que la lumière change, quelque chose se met à vivre dans ce noir. Des stries horizontales et verticales, creusées à la spatule dans l'acrylique épais, captent la lumière de la salle différemment selon l'angle : certaines zones brillent d'un éclat presque métallique, d'autres restent dans une obscurité mate.",
      "Bougez lentement devant la toile. Regardez comment les zones lumineuses et les zones sombres se déplacent avec vous. Ce tableau n'est pas le même d'un côté de la salle et de l'autre. Il n'est pas le même le matin avec la lumière naturelle et le soir sous les spots artificiels. Soulages disait que ses toiles sont des pièges à lumière — non pas pour l'absorber, mais pour la transformer. Le noir n'est pas une absence ici : c'est un prisme.",
      "Le titre indique la date exacte — 22 avril 2002. Soulages donnait ainsi à ses œuvres une date de naissance précise, comme un état civil. Pas un titre poétique, pas un numéro de série : une date. Ce tableau a un jour de naissance. Il a eu lieu quelque part, dans l'atelier de Soulages à Paris, un mardi d'avril. Et depuis ce jour, il vit de la lumière que lui donnent les salles où il est exposé."
    ],
    "lecon_titre": "Cherche la lumière dans le noir",
    "lecon_texte": "Soulages a eu soixante ans quand il a découvert l'Outrenoir. Pendant quarante ans, il avait peint avec du noir — et puis un jour, en regardant une toile ratée, il a vu que le noir pouvait faire de la lumière. Pas malgré le noir : grâce au noir. Chercher la lumière dans le noir, c'est la leçon finale de ce voyage avec Mona à travers les musées. Ce n'est pas naïf — c'est la chose la plus difficile et la plus nécessaire. Même quand tout semble obscur, la lumière existe, révélée par la matière si l'on apprend à regarder.",
    "lecon_mot_cle": "même dans l'obscurité totale, la lumière existe — il faut apprendre à la voir",
    ...
    "grandparent_conseil": "Cherchez ensemble la zone du tableau où la lumière est la plus intense — là où les stries captent le mieux les spots de la salle. Et trouvez la zone la plus mate, la plus sombre. Entre les deux, il y a tout un dégradé de noirs différents. Soulages disait qu'il n'y a pas un noir — il y a autant de noirs que de lumières. C'est la même chose pour les gens : on ne connaît quelqu'un vraiment qu'en voyant comment la lumière se réfléchit sur lui.",
    "mot_mystere_mot": "L'Outrenoir",
    "mot_mystere_texte": "L'Outrenoir est un mot inventé par Pierre Soulages pour désigner sa découverte de 1979 : le noir utilisé non comme couleur qui absorbe la lumière, mais comme surface qui la réfléchit et la transforme. Le préfixe « outre- » vient du latin ultra, qui signifie « au-delà ». L'Outrenoir, c'est donc le au-delà du noir — ce qui se passe quand le noir cesse d'être une fin et devient un commencement. En travaillant la peinture acrylique noire en stries épaisses avec une spatule, Soulages crée des surfaces qui agissent comme des prismes : elles décomposent la lumière ambiante en zones d'éclat et d'ombre qui bougent avec le spectateur. Ses toiles outrenoir sont des œuvres vivantes — elles changent selon l'heure du jour, la météo, la position du regardeur.",
    "anecdote": "Pierre Soulages est né à Rodez, en Aveyron, à quelques kilomètres de l'abbatiale Sainte-Foy de Conques — une église romane aux vitraux exceptionnels. En 1994, le musée de Conques lui commanda de nouveaux vitraux pour l'abbatiale. Soulages créa cent quatre fenêtres en verre translucide gris-blanc, sans décor ni figure — juste la lumière filtrée. Les habitants protestèrent : ils voulaient des vitraux colorés et figuratifs, comme partout ailleurs. Aujourd'hui, les vitraux de Soulages à Conques sont considérés parmi les plus beaux d'Europe : des pans de lumière changeante qui transforment l'intérieur de l'abbaye selon l'heure et la saison. Il vécut jusqu'à cent deux ans — et travailla jusqu'à la fin."
  }
];
