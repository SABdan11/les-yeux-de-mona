const OEUVRES = [
  ...
  },
  {
    ...
    "ce_quon_voit": ["Un tableau presque carré, deux mètres sur deux mètres vingt, fait de cinq grandes bandes horizontales sombres sur un panneau de bois. Entre les bandes, quatre traits au pastel clair — Mona les appellera « quatre rais de lumière ». Les bandes ne sont pas uniformes : le bois laisse passer ses veines, ses aspérités, ses nuances de brun et de rouille. Et sur les côtés du tableau, deux marges verticales révèlent un fond peint en dessous — des formes blanches et noires à moitié cachées par le panneau du dessus. L'œuvre garde des secrets sous sa surface.", "Ce jour-là, c'est Mona qui parle la première. Dadé s'est planté devant le tableau en silence — une heure entière, les cheveux plaqués en arrière, le regard englouti dans les masses sombres. Quand il se retourne enfin, elle est là, qui attendait. « C'est à mon tour », dit-elle. Et elle nomme ce qu'elle voit dans chaque bande : un deuil, la joie, la croissance, la violence, la guérison. Cinq tranches d'une vie. Puis elle remarque les côtés — ces formes cachées sous le panneau de bois. « Ça veut dire qu'il faut toujours regarder plus loin que ce qu'on voit », dit-elle. Dadé hoche la tête sans rien ajouter.", "Soulages est né en 1919 dans le sud de la France. En 1979, il invente l'outrenoir : un noir travaillé jusqu'à devenir lumineux, qui capte et redistribue la lumière au lieu de l'absorber. Des noirs qui ne sont plus vraiment noirs. « Si on mélange toutes les couleurs, on obtient du noir », dit Mona. « Donc le noir est une couleur. C'est même une couleur à perte de vue. » C'est la dernière visite. Dadé et Mona sont restés devant ce tableau plus longtemps que devant tous les autres."],
